...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', action='store', type=str, required=False, help='Directory containing the uncompressed datasets.',default="/home/slishy/Code/act-plus-plus/data")
